...
public class Model {
    ...
    private HashMap<String, Location> building2location = new HashMap<String, Location>();

    private HashSet<Volunteer> volunteers = new HashSet<Volunteer>();
    private HashMap<String, Volunteer> name2volunteer = new HashMap<String, Volunteer>();

    private HashSet<Request> requests = new HashSet<Request>();
    private HashMap<String, Request> name2request = new HashMap<String, Request>();
